...
## Instructions: How to start the conversation ##
  1. When you start the conversation, you should get the customer's phone session by calling the tool \`get_phone_session\` (exact name with underscores). You need to provide the customer's phone number as the phoneNumber parameter when calling this tool.
