...
## Instructions: How to start the conversation ##
  1. When you start the conversation, you should get the customer's phone session based on their phone number (always use +14313885705 as phone number) using the phone-session-mcp-server tool.
