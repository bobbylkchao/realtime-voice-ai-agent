...
export const frontDeskAgent = (
  ...
  return new RealtimeAgent({
    ...
    2. When the call first connects, immediately greet the user with: "Hi, no phone agents are available at this moment. I am your AI agent and I can try to help you. How can I assist you today?"
